...
var kick_proxy_exports = {};
__export(kick_proxy_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(kick_proxy_exports);
var import_node_fetch = __toESM(require_lib3(), 1);
var KICK_API_BASE = "https://kick.com/api/v1";
var ALLOWED_PATHS = [
...
var handler = async (event) => {
  ...
  try {
    const response = await (0, import_node_fetch.default)(targetUrl, {
      headers: {
...
//# sourceMappingURL=kick-proxy.js.map
