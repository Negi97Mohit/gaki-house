    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <main className="container max-w-4xl mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-semibold prose-a:text-primary hover:prose-a:text-primary/80 prose-a:transition-colors">
          ...
          <ul>
            <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named GAKI - House of Video Creation.</li>
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to GAKI - House of Video Creation.</li>
