...
export const useSceneManager = ({ }: UseSceneManagerProps) => {
  ...
  useEffect(() => {
    ...
    if (sceneStore.emptyGridPanels !== activeScene.emptyGridPanels)
      sceneStore.setEmptyGridPanels(activeScene.emptyGridPanels ?? []);
  ...
  const storeValues = {
    ...
    emptyGridPanels: sceneStore.emptyGridPanels,
  ...
  useEffect(() => {
    ...
    updateActiveScene((prev) => {
      ...
      if (next.emptyGridPanels !== storeValues.emptyGridPanels) {
        next.emptyGridPanels = storeValues.emptyGridPanels;
        modified = true;
      }
