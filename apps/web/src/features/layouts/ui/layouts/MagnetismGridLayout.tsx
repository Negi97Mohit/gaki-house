...
export const MagnetismGridLayout: React.FC<MagnetismGridLayoutProps> = ({
  ...
  const currentFontSize = focusedField
    ? layout.customSectionStyles?.[focusedField.id]?.fontSize || "16"
    : "16";
  const currentAlign = focusedField
    ? layout.customSectionStyles?.[focusedField.id]?.textAlign || "left"
    : "left";
  const isBold = focusedField
    ? layout.customSectionStyles?.[focusedField.id]?.bold || false
    : false;
  const isItalic = focusedField
    ? layout.customSectionStyles?.[focusedField.id]?.italic || false
    : false;
      ...
      {focusedField && (
        ...
        >
          <div className="flex items-center gap-2 mr-2 border-r border-white/20 pr-2">
            ...
            <input
              ...
              onBlur={(e) => {
                ...
                if (!e.target.value)
                  handleUpdateStyle(focusedField.id, "fontSize", "16");
              }}
          ...
          <div className="flex items-center bg-white/10 rounded-lg p-0.5 gap-0.5">
            <button
              onClick={() =>
                handleUpdateStyle(focusedField.id, "textAlign", "left")
              }
            ...
            <button
              onClick={() =>
                handleUpdateStyle(focusedField.id, "textAlign", "center")
              }
            ...
            <button
              onClick={() =>
                handleUpdateStyle(focusedField.id, "textAlign", "right")
              }
              onMouseDown={(e) => e.preventDefault()}
              className={cn(
                "p-1.5 rounded-md transition-colors",
          ...
          <div className="flex items-center gap-1">
            <button
              onClick={() =>
                handleUpdateStyle(focusedField.id, "bold", !isBold)
              }
              onMouseDown={(e) => e.preventDefault()}
              className={cn(
                "p-1.5 rounded-md transition-colors",
            ...
            <button
              onClick={() =>
                handleUpdateStyle(focusedField.id, "italic", !isItalic)
              }
              onMouseDown={(e) => e.preventDefault()}
              className={cn(
                "p-1.5 rounded-md transition-colors",
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <div className="flex gap-6 text-xs md:text-sm border-t border-black/10 pt-4 mt-8 opacity-60">
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdateText("header", "date", e.target.value)
                      }
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdateText("header", "category", e.target.value)
                      }
                ...
                <div className="text-sm md:text-base leading-relaxed">
                  <textarea
                    value={
                      headerData.subtitle ??
                      "Performance, aesthetics, technicality."
                    }
                    onChange={(e) =>
                      handleUpdateText("header", "subtitle", e.target.value)
                    }
                  ...
                  <textarea
                    value={
                      ...
                      "Since 2018, Richard Mille, celebrated by elites in sports, arts, and cinema, has partnered with Magnetism to accelerate its brand development globally. This comprehensive collaboration spans strategic vision implementation and management of its digital ecosystem."
                    }
                    onChange={(e) =>
                      handleUpdateText("header", "description", e.target.value)
                    }
          ...
          <div className="lg:col-span-8 xl:col-span-9">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {gridSections.map((section, index) => {
                ...
                const customStyle =
                  layout.customSectionStyles?.[section.id] || {};
                ...
                const aspectStyle = customStyle.aspectRatio
                  ...
                  : { aspectRatio: defaultStyle.aspect };
              ...
              {/* Add Button */}
              <div
                className="md:col-span-1 aspect-square flex items-center justify-center border-2 border-dashed border-black/10 rounded hover:bg-black/5 cursor-pointer transition-colors"
