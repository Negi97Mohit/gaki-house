        ...
        return (
            <div className="min-h-full">
                <div className="px-4 pt-4 pb-2">
                    <h1 className="text-xl font-bold text-foreground">{cat?.name || category}</h1>
                ...
                <div className="px-3 space-y-3 pb-6">
                    ...
                    {categoryStreams.length === 0 && (
                        <p className="text-muted-foreground text-xs text-center py-12">No streams in this category right now.</p>
                    )}
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-full">
            ...
            <div className="px-4 pt-3 pb-2">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-muted/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/30 transition-all"
                    />
                </div>
            </div>
            ...
            <div className="px-3 pt-2">
                <h2 className="text-sm font-bold text-foreground mb-3 px-1">Categories</h2>
                    ...
                    {filteredCategories
                        ...
                        .map((cat) => (
                            <Link
                                ...
                                className="relative rounded-xl overflow-hidden aspect-[4/5] active:scale-[0.97] transition-transform"
                            >
                                <img
                                    src={cat.thumbnail}
                                    alt={cat.name}
            ...
            <div className="px-3 pt-6 pb-6">
                <h2 className="text-sm font-bold text-foreground mb-3 px-1">Live Now</h2>
