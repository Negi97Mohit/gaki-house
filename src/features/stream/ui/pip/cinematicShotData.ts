...
export const CINEMATIC_PRESETS: CinematicPreset[] = [
  ...
  { id: "slow-motion", name: "Slow Motion", description: "Slight brightness & cool tint", color: "#4488CC", category: "motion" },
  { id: "hyperlapse", name: "Hyperlapse", description: "Strobing radial vignette", color: "#55AACC", category: "motion" },
  { id: "timelapse", name: "Time-lapse", description: "Animated bright saturated shift", color: "#66BBAA", category: "motion" },
