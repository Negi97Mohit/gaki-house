  ...
  return (
    <div className="relative w-full h-full">
      {template.sections.map((templateSection) => {
        // Safely access layout.sections with fallback to empty array
        const section =
        ...
        return (
          <div
            ...
            // We still track this for resize logic, but GridSectionWrapper now handles its own hover for toolbar visibility
