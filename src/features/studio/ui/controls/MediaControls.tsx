// src/features/studio/ui/controls/MediaControls.tsx
...
// Define the Target interface locally or import it if you moved it to a types file
...
interface MediaControlsProps {
  // UPDATED: Now accepts an array of targets
...
export const MediaControls: React.FC<MediaControlsProps> = ({
  ...
  const { isBroadcasting, isConnecting, streamStatus } = useStreamStore(
    useShallow((state) => ({
  ...
  return (
    <>
      ...
      <StreamConfigurationModal
        ...
        status={streamStatus}
        // UPDATED: Now matches the new signature from the hook
        onStartStream={onStartStream as any}
