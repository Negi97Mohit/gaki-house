            ...
            >
              <div className="relative">
                <EditableText
                  ...
                  className="text-[12vw] font-serif leading-[0.85] mix-blend-difference text-center bg-transparent text-white"
                  multiline
                />
              </div>
              <div className="mt-8">
                <EditableText
                  ...
                  className="font-mono text-sm tracking-widest uppercase text-center bg-transparent text-white/80"
                />
              </div>
            </motion.div>
          </div>
