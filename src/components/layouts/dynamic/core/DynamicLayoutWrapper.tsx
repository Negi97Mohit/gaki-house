...
export const DynamicLayoutWrapper: React.FC<DynamicLayoutWrapperProps> = ({
    ...
    // 2. Global Colors
    const colors = editor.getGlobalSettings(defaultBackgroundColor, defaultTextColor);
    ...
    return (
        <DynamicLayoutProvider value={{
            ...
            >
                ...
                <div className={controlsVisible ? "opacity-100 transition-opacity duration-300" : "opacity-0 pointer-events-none transition-opacity duration-300"}>
                    <LayoutSettingsCtrl
                ...
                <LayoutEditorToolbar
                    ...
                    currentStyle={editor.focusedField ? layout.customSectionStyles?.[editor.focusedField.id] : {}}
                    onUpdateStyle={(field, value) => editor.focusedField && editor.handleUpdateStyle(editor.focusedField.id, field, value)}
