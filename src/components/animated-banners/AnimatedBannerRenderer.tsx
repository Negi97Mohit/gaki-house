...
import { BannerBackgroundRenderer } from "./BannerBackgroundRenderer";
...
export const AnimatedBannerRenderer: React.FC<AnimatedBannerRendererProps> = ({
  ...
  // Helper to determine if we should show text controls for the SELECTED element
  ...
  return (
    ...
    >
      ...
      <BannerBackgroundRenderer design={design} />
      ...
      <AnimatePresence>
        {isEditing && (
          <BannerCustomizationToolbar
            ...
            onElementToggle={handleVisibilityChange}
            onElementStyleChange={handleStyleChange}
            onBackgroundChange={(color) =>
              onContentChange?.("backgroundColor", color)
            }
            onPrimaryColorChange={(color) =>
              onContentChange?.("primaryColor", color)
            }
            onSecondaryColorChange={(color) =>
              onContentChange?.("secondaryColor", color)
            }
            onAddElement={() => {}}
