...
export const TopToolbar = ({
  ...
  return (
    <div className="h-14 border-b border-border/40 bg-background/80 backdrop-blur-sm px-4 flex items-center gap-3">
      {" "}
      {/* Logo */}
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <Button
          ...
          title={
            captureRejectionSymbol ? "Turn on Caption" : "Turn off Caption"
          }
        >
          {captionsEnabled ? (
